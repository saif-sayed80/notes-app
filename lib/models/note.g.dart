...
const NoteSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'subtitle': IndexSchema(
      id: -890270649826766767,
      name: r'subtitle',
      unique: false,
      replace: false,
      properties: [
...
Note _noteDeserialize(
  ...
  final object = Note(
    ...
    isPinned: reader.readBool(offsets[1]),
    subtitle: reader.readString(offsets[2]),
...
extension NoteQueryWhereSort on QueryBuilder<Note, Note, QWhere> {
  ...
  QueryBuilder<Note, Note, QAfterWhere> anyDateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension NoteQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> subtitleEqualTo(String subtitle) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'subtitle',
        value: [subtitle],
      ));
    });
  }

  QueryBuilder<Note, Note, QAfterWhereClause> subtitleNotEqualTo(
      String subtitle) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> dateTimeEqualTo(
      DateTime dateTime) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> dateTimeNotEqualTo(
      DateTime dateTime) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> dateTimeGreaterThan(
    DateTime dateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> dateTimeLessThan(
    DateTime dateTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> dateTimeBetween(
